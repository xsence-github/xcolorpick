...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMinimumSize(QtCore.QSize(400, 360))
        Dialog.setMaximumSize(QtCore.QSize(400, 360))
...
"border-color: rgb(91, 91, 91);")
        ...
        self.img_preview.setGeometry(QtCore.QRect(10, 10, 266, 266))
        ...
        self.pushButton.setGeometry(QtCore.QRect(295, 276, 90, 40))
        self.pushButton.setObjectName("pushButton")
        self.line_h = QtWidgets.QFrame(Dialog)
        self.line_h.setGeometry(QtCore.QRect(10, 140, 256, 16))
        ...
        self.line_v.setGeometry(QtCore.QRect(110, 10, 16, 256))
